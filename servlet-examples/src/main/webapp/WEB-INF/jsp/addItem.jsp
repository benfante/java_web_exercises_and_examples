	...
	<div class="container">
		...
		<form action="${addUrl}" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control col-md-3 col-sm-12" id="costId" name="cost"
					value="${param.cost}" placeholder="Item cost" />
			</div>
			<div class="form-group">
				<label for="priorityId">Priority:</label>
				<input class="form-control col-md-3 col-sm-12" id="priorityId"
